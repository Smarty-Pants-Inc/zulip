...
from .configured_settings import (
    ...
    BRAND_ATTRIBUTION_URL,
    BRAND_AUTHENTICATION_DOCS_URL,
    BRAND_BLOG_URL,
    BRAND_GITHUB_URL,
    BRAND_HELP_URL,
    BRAND_LINKEDIN_URL,
    ...
    BRAND_NAME,
    BRAND_OG_IMAGE_URL,
    BRAND_POWERED_BY_ZULIP,
    BRAND_SELF_HOSTED_BILLING_LOGIN_URL,
    BRAND_SERVER_INSTALLATION_URL,
    BRAND_SERVER_UPGRADE_URL,
    BRAND_STATUS_URL,
    BRAND_SUPPORT_EMAIL,
    BRAND_SUPPORT_PROJECT_URL,
    BRAND_TROUBLESHOOTING_URL,
    BRAND_TWITTER_URL,
    BRAND_WEBSITE_URL,
    CAMO_URI,
...
# Allow environment variable overrides for BRAND_* settings.
BRAND_NAME = os.environ.get("BRAND_NAME", BRAND_NAME)
BRAND_WEBSITE_URL = os.environ.get("BRAND_WEBSITE_URL", BRAND_WEBSITE_URL)
BRAND_HELP_URL = os.environ.get("BRAND_HELP_URL", BRAND_HELP_URL)
BRAND_STATUS_URL = os.environ.get("BRAND_STATUS_URL", BRAND_STATUS_URL)
BRAND_BLOG_URL = os.environ.get("BRAND_BLOG_URL", BRAND_BLOG_URL)
BRAND_GITHUB_URL = os.environ.get("BRAND_GITHUB_URL", BRAND_GITHUB_URL)
BRAND_TWITTER_URL = os.environ.get("BRAND_TWITTER_URL", BRAND_TWITTER_URL)
BRAND_MASTODON_URL = os.environ.get("BRAND_MASTODON_URL", BRAND_MASTODON_URL)
BRAND_LINKEDIN_URL = os.environ.get("BRAND_LINKEDIN_URL", BRAND_LINKEDIN_URL)
BRAND_SUPPORT_PROJECT_URL = os.environ.get("BRAND_SUPPORT_PROJECT_URL", BRAND_SUPPORT_PROJECT_URL)
BRAND_ATTRIBUTION_URL = os.environ.get("BRAND_ATTRIBUTION_URL", BRAND_ATTRIBUTION_URL)
BRAND_SELF_HOSTED_BILLING_LOGIN_URL = os.environ.get(
    "BRAND_SELF_HOSTED_BILLING_LOGIN_URL", BRAND_SELF_HOSTED_BILLING_LOGIN_URL
)
BRAND_AUTHENTICATION_DOCS_URL = os.environ.get(
    "BRAND_AUTHENTICATION_DOCS_URL", BRAND_AUTHENTICATION_DOCS_URL
)
BRAND_TROUBLESHOOTING_URL = os.environ.get("BRAND_TROUBLESHOOTING_URL", BRAND_TROUBLESHOOTING_URL)
BRAND_SERVER_INSTALLATION_URL = os.environ.get(
    "BRAND_SERVER_INSTALLATION_URL", BRAND_SERVER_INSTALLATION_URL
)
BRAND_SERVER_UPGRADE_URL = os.environ.get("BRAND_SERVER_UPGRADE_URL", BRAND_SERVER_UPGRADE_URL)
BRAND_SUPPORT_EMAIL = os.environ.get("BRAND_SUPPORT_EMAIL", BRAND_SUPPORT_EMAIL)

if "BRAND_OG_IMAGE_URL" in os.environ:
    BRAND_OG_IMAGE_URL = os.environ["BRAND_OG_IMAGE_URL"] or None

_brand_powered_by_zulip = get_env_bool("BRAND_POWERED_BY_ZULIP")
if _brand_powered_by_zulip is not None:
    BRAND_POWERED_BY_ZULIP = _brand_powered_by_zulip
